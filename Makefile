...
test: ##=> Run pytest
	@POWERTOOLS_TRACE_DISABLED=1 POWERTOOLS_METRICS_NAMESPACE="MyServerlessApplication" \
		TEXTRACT_NOTIFICATION_TOPIC="textract_notification_topic" TEXTRACT_NOTIFICATION_ROLE="textract_notification_role" ANALYSIS_RESULT_TOPIC="analysis_result_topic" \
